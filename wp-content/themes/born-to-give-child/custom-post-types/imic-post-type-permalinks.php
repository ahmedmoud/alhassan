...
__("Permalink Settings for custom post type and their taxonomy",'framework'),
...
?>
<p>
<?php _e("If you don't entered permalink structure, permalink is configured as post type",'framework');?>
</p>
<?php
}
...
echo '<p><code>'.home_url().'/'.$term.'</code> <input name="structure_'.$term.'" id="'.$term.'" type="text" class="regular-text code" value="' . $term_value .'" /></p>';
}}
?>