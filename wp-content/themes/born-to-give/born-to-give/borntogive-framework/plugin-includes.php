...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
		...
		array(
       	...
       	array(
			'name' => esc_html__('WooCommerce - excelling eCommerce', 'vestige'),
		    'slug' => 'woocommerce',
			'required' 	=> false,
		),
		array(
		...
		array(
			'name' => __('Contact Form 7', 'borntogive'),
		    'slug' => 'contact-form-7',
			'required' 	=> false,
		),
		array(
			'name' => __('TinyMCE Advanced', 'borntogive'),
		 ...
		 array(
            ...
            'version' 			 => '5.3.1.5', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
			array(
            'name'               => 'Born to Give Core', // The plugin name.
		...
		array(
            'name'               => 'imic Shortcodes', // The plugin name.
		...
		array(
            'name'               => 'borntogive vc elements', // The plugin name.
