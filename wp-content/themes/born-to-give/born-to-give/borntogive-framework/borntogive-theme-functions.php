    ...
    function borntogive_maintenance_mode() {
        ...
        if ($maintenance_mode) {
            if (!current_user_can('edit_themes') || !is_user_logged_in()) {
                wp_die($custom_logo_output . '<p style="text-align:center">' . __('We are currently in maintenance mode, please check back shortly.', 'borntogive') . '</p>', __('Maintenance Mode', 'vestige'));
            }
        }
    }
...
@media only screen and (max-width: 992px) {
	.dd-menu > li:hover > a, .dd-menu > li:hover > a > i{
		...
		{
			echo '.topbar .container, .fw-menu-wrapper .container{width:100%;}';
		}
		if ($SiteMinHeight != '')
		{
...
function borntogive_contact_event_manager(){
	...
	update_post_meta($registrant_id, 'borntogive_registrant_event_date', '');
