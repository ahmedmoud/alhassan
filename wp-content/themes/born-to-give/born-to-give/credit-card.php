...
//if(jQuery('.DonationForm input.wpcf7-validates-as-email').val()==''){}
                                            ...
                                            if (jQuery('.DonationForm .Currency select option:selected').attr('value') == "EGP") {
                                                jQuery('.BAFDonate [name="vpc_AccessCode"]').attr('value', '3E33EBA6');
                                                jQuery('.BAFDonate [name="al_secure"]').attr('value', '138EA436D864BF9B5A26BF93BAE91480');
                                                jQuery('.BAFDonate [name="vpc_Merchant"]').attr('value', '701154');
...
//if(jQuery('.DonationForm input.wpcf7-validates-as-email').val()==''){}
                                            ...
                                            if (jQuery('.DonationForm .Currency select option:selected').attr('value') == "EGP") {
                                                ...
                                                jQuery('.BAFDonate [name="vpc_AccessCode"]').attr('value', '02FBF1BA');
                                                jQuery('.BAFDonate [name="al_secure"]').attr('value', 'A37CA86C8840BD63D1012E5EACF622A6');
                                                jQuery('.BAFDonate [name="vpc_Merchant"]').attr('value', '701155');
