...
<?php elseif ( 'link' === $block ) :  ?>
	<a href="<?php echo $post->link ?>" class="vc_read_more" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'js_composer' ), $post->title_attribute ) ); ?>"<?php echo $this->link_target ?>><?php _e( 'Read more more', 'js_composer' ) ?></a>
<?php endif ?>
